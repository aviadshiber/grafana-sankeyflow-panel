...
| CII Best Practices  | External self-certification is not yet complete. Do not display an OpenSSF Best Practices badge until the repository has a corresponding public assessment.                                                                                                                                                                                                           | Complete and publish the authenticated application at `bestpractices.dev`.                       |
